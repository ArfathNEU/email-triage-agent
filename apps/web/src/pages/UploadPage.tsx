      ...
      {error && (
        <div className="mt-4 rounded-md border border-red-200 bg-red-50 p-4">
          ...
          <p className="mt-1 text-sm text-red-700">
            {errorBody?.message ?? (error as Error).message}
          </p>
        </div>
      )}
        ...
        <div className="mt-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
          ...
          <dl className="mt-2 grid grid-cols-3 gap-4">
            <div>
              ...
              <dd className="text-lg font-semibold text-gray-900">{result.inserted}</dd>
            </div>
            <div>
              <dt className="text-xs text-gray-500">Skipped</dt>
              <dd className="text-lg font-semibold text-gray-900">{result.skipped}</dd>
            </div>
            <div>
              <dt className="text-xs text-gray-500">Total in DB</dt>
              <dd className="text-lg font-semibold text-gray-900">{result.totalEmailsInDb}</dd>
            </div>
          </dl>
