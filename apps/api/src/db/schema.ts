// SQL schema as a TypeScript module so that tsc bundles it into dist/.
// Source of truth — keep schema.sql in sync if you edit either one (it
// remains in the tree for human readability but is not loaded at runtime).
